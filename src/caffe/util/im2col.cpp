...
void im2col_gpu(const cl_mem data_im, const int channels,
    ...
    cl_event eventPoint;
    size_t uiGlobal_Work_Size[]={channels * height_col * width_col * 1};
...
template void im2col_gpu<float>(const cl_mem data_im, const int channels,
    const int height, const int width, const int ksize, const int pad,
    const int stride, float* data_col);
template void im2col_gpu<double>(const cl_mem data_im, const int channels,
    const int height, const int width, const int ksize, const int pad,
